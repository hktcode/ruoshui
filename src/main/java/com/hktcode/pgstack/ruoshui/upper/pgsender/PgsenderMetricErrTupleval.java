...
public class PgsenderMetricErrTupleval implements PgsenderMetricErr
{
    static PgsenderMetricErrTupleval of(PgsenderMetricEndTupleval metric, Throwable throwerr)
    {
        if (metric == null) {
        ...
        return new PgsenderMetricErrTupleval(metric, throwerr);
    }

    private PgsenderMetricErrTupleval(PgsenderMetricEndTupleval metric, Throwable throwerr)
    {
