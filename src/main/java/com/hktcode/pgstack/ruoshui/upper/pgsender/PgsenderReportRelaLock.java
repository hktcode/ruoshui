...
{
    static PgsenderReportRelaLock of(PgsenderActionDataRelaLock action, long finish)
    {
        if (action == null) {
    ...
    private PgsenderReportRelaLock(PgsenderActionDataRelaLock action, long finish)
    {
