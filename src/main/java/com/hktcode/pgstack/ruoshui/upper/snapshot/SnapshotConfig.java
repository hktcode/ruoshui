...
import static com.hktcode.pgstack.ruoshui.upper.mainline.MainlineConfig.DEFAULT_RS_FETCHSIZE;

public class SnapshotConfig extends TqueueConfig
{
    private static final Logger logger = LoggerFactory.getLogger(SnapshotConfig.class);

    public static SnapshotConfig ofJsonObject(JsonNode json, LogicalReplConfig logicalRepl) //
        ...
        /* */) //
    {
        ...
        return new SnapshotConfig(srcProperty, relationSql, whereScript, lockingMode, logicalRepl, tupleSelect);
    }
