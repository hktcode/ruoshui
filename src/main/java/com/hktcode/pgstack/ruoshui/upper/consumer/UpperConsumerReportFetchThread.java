...
public class UpperConsumerReportFetchThread
{
    public static UpperConsumerReportFetchThread //
    of(MainlineResult mainline, ImmutableList<SnapshotResult> snapshot)
    {
        ...
        return new UpperConsumerReportFetchThread(mainline, snapshot);
    }
    ...
    private UpperConsumerReportFetchThread //
