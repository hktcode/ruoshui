...
public class PgsenderMetricErrSsFinish implements PgsenderMetricErr
{
    static PgsenderMetricErrSsFinish of(PgsenderMetricEndSsFinish metric, Throwable throwerr)
    {
        if (metric == null) {
        ...
        return new PgsenderMetricErrSsFinish(metric, throwerr);
    }

    private PgsenderMetricErrSsFinish(PgsenderMetricEndSsFinish metric, Throwable throwerr)
    {
